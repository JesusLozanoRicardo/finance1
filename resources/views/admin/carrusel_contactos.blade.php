...
<div class="row">
    ...
    <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            @if ($carrusel_contactos==null)
              <form role="form" method="POST" action="{{route('carrusel_contactos.store')}}" enctype="multipart/form-data">
            @else
               <form role="form" method="POST" action="{{route('carrusel_contactos.update',$carrusel_contactos->id)}}" enctype="multipart/form-data">
            @endif
                @csrf
                @method('PUT')
              <div class="card-body">
                ...
                <div class="input-group">
                    @if ($carrusel_contactos!=null)
                       <img src="{{asset("images/carrusel_contactos/$carrusel_contactos->imagen")}}" id="pre" class="img-fluid mb-2" alt="No hay imagen que mostrar">
                    @endif
