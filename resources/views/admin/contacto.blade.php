...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-primary">
            ...
            @if ($contacto==null)
               <form role="form"method="POST" action="{{route('contacto.store')}}">
                  @csrf
            @else
               <form role="form"method="POST" action="{{route('contacto.update',$contacto->id)}}">
                  @csrf
                  @method('PUT')
            ...
            @if ($contacto!=null)
              <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="texto1" value="{{$contacto->texto1}}" id="texto1" placeholder="Introduzca texto1">
                </div>
                <div class="form-group">
                    <label for="texto2">Texto2:</label>
                    <input type="text" class="form-control" name="texto2" value="{{$contacto->texto2}}" id="texto2" placeholder="Introduzca texto2">
                </div>
                <div class="form-group">
                    <label for="texto3">Texto3:</label>
                    <input type="text" class="form-control" name="texto3" value="{{$contacto->texto3}}" id="texto3" placeholder="Introduzca texto3">
                </div>
              </div>
              @else
              <div class="card-body">
            ...
            @endif
              ...
              @if ($contacto!=null)
                <form role="form" name="eliminar" id="eliminar"  method="POST" action="{{route('contacto.destroy',$contacto->id)}}">
                  @csrf
                  @method('delete')
              <div class="card-footer">
