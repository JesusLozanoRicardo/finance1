...
<div class="row">
    ...
    <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            @if ($inicio_imagenes==null)
            <form role="form" method="POST" action="{{route('inicio_imagenes.store')}}" enctype="multipart/form-data">
                @csrf
            @else
            <form role="form" method="POST" action="{{route('inicio_imagenes.update',$inicio_imagenes->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            @endif
              <div class="card-body">
                ...
                <div class="input-group">
                    @if ($inicio_imagenes!=null)
                    <img src="{{asset("images/inicio/$inicio_imagenes->imagen")}}" id="pre" class="img-fluid mb-2" alt="No hay imagen que mostrar">
                    @endif
