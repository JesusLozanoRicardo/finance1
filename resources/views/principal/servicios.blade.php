...
-->
  ...
  <body>
    ...
    <!-- Page Content -->
    @if(!empty($carrusel_servicios->imagen))
    <div class="page-heading header-text" style="background-image: url({{asset("images/carrusel_servicios/$carrusel_servicios->imagen")}});">
    @else
    ...
    @endif
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          @if (!empty($header->texto1_servicios))
            <h1>{{$header->texto1_servicios}}</h1>
            <span>{{$header->texto2_servicios}}</span>
          @else
          <h1>Encabezado texto1 servicios</h1>
          <span>Encabezado texto2 servicios</span>
          @endif
          </div>
        </div>
      </div>
          ...
          <div class="col-md-4">
            ...
            @if ($servicio->count()>0)
               ...
               @foreach ($servicio as $item )
                 @php($i++)
                 <li><a href='#tabs-{{$i}}'>{{$item->texto1}}<i class="fa fa-angle-right"></i></a></li>
               @endforeach
            @else
                 <li><a href='#tabs-1'>Servicio1<i class="fa fa-angle-right"></i></a></li>
                 <li><a href='#tabs-2'>Servicio2<i class="fa fa-angle-right"></i></a></li>
            @endif
            </ul>
          </div>
          <div class="col-md-8">
            ...
            @if ($servicio->count()>0)
                ...
                @php($i++)
                  <article id='tabs-{{$i}}'>
                     <img style="width:500px !important; " src="{{asset("images/servicio/$item->imagen")}}"/>
                     <h4>{{$item->texto1}}</h4>
                     <p>{{$item->texto2}}
                     <br><br></p>
                  </article>
            ...
            @else
            <article id='tabs-1'>
                <img style="width:500px !important; " alt="servicio imagen1" />
                <h4>Servicio texto1</h4>
                <p>Servicio texto2
                <br><br></p>
             </article>
             <article id='tabs-2'>
                <img style="width:500px !important; " alt="servicio imagen2"/>
                <h4>Servicio texto1</h4>
                <p>Servicio texto2
                <br><br></p>
             </article>
