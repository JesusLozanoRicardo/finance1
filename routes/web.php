...
Route::get('/', function () {
    ...
    return view('/principal/index',compact("header","socialnetwork","inicio_imagenes","carrusel","servicio","crecimiento","datos","quienes","encabezados_dicen","datos_dicen","contacto","footer_titulo","footer_utiles"));
});
...
Route::get('/contactos', function () {
    ...
    $mapa = Mapa::first();
    $socialnetwork = Socialnetwork::first();
    return view('/principal/contacto',compact("header","socialnetwork","mapa","carrusel","servicio","crecimiento","datos","quienes","encabezados_dicen","datos_dicen","contacto","footer_titulo","footer_utiles","carrusel_contactos","datos_miembros","locations"));
});
...
Route::get('/nosotros', function () {
    ...
    $footer_utiles = Footer_util::all();
    $socialnetwork = Socialnetwork::first();
    return view('/principal/about',compact("header","socialnetwork","carrusel","servicio","crecimiento","datos","quienes","encabezados_dicen","datos_dicen","contacto","footer_titulo","footer_utiles","carrusel_nosotros","carrusel_servicios","encabezado_miembros","datos_miembros"));
});
...
Route::get('/servicios', function () {
   ...
   // $config = Config::find(1);
    return view('/principal/servicios',compact("header","socialnetwork","carrusel","servicio","carrusel_servicios","footer_titulo","footer_utiles"));
});
...
Route::middleware(['auth:sanctum', 'verified'])->resource('admin/mapa', MapaController::class);
Route::middleware(['auth:sanctum', 'verified'])->resource('admin/pass', PassController::class);
Route::middleware(['auth:sanctum', 'verified'])->resource('admin/socialnetwork', SocialnetworkController::class);
...
/*Mail::to("$for")->send(new \App\Mail\MailSend($details));*/

$subject = "$request->subject";
        Mail::send('mail',[ 'name' => "$request->name",
        'email' => "$request->email",
